...
def opcua_node_setting(node, endpoint="opc.tcp://127.0.0.1:4840/", timeout=5000,
                       enable_auth=False, username="", password="",
                       read_mode=0, publish_interval=500):
    return node_setting(node, json={
        "endpoint": endpoint,
        "timeout": timeout,
        "enable_auth": 1 if enable_auth else 0,
        "username": username,
        "password": password,
        "read_mode": read_mode,

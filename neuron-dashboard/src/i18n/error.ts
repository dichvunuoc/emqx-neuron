...
export default {
  ...
  1002: {
    ...
    vi: 'Request body invalid',
  },
  1003: {
    zh: '请求 param 无效',
    en: 'Request param invalid',
    vi: 'Request param invalid',
  },
  1004: {
    zh: '缺少令牌',
    en: 'Missing token',
  ...
  1012: {
    ...
    vi: 'Password length too short or too long',
  },
  1013: {
    zh: '密码重复',
    en: 'Duplicate password',
    vi: 'Duplicate password',
  },
  1014: {
    zh: '执行指令失败',
    en: 'Command execution failed',
    vi: 'Command execution failed',
  },
  1015: {
    zh: 'IP 地址无效',
    en: 'Invalid ip address',
    vi: 'Invalid ip address',
  },
  1016: {
    zh: 'IP 地址已占用',
    en: 'IP address in use',
    vi: 'IP address in use',
  },
  1017: {
    zh: '用户名无效',
    en: 'Invalid user',
  ...
  2004: {
    ...
    vi: 'Node setting invalid',
  },
  2005: {
    zh: 'Node 设置未找到',
    en: 'Node setting not found',
    vi: 'Node setting not found',
  },
  2006: {
    zh: 'Node 未准备好',
    en: 'Node not ready',
  ...
  2010: {
    ...
    vi: 'Node name too long',
  },
  2011: {
    zh: 'Node 不允许删除',
    en: 'Node not allow delete',
    vi: 'Node not allow delete',
  },
  2012: {
    zh: 'Node 不允许订阅',
    en: 'Node not allow subscribe',
    vi: 'Node not allow subscribe',
  },
  2013: {
    zh: 'Node 不允许更新',
    en: 'Node not allow update',
    vi: 'Node not allow update',
  },
  2014: {
    zh: 'Node 不支持图',
    en: 'Node not allow map',
    vi: 'Node not allow map',
  },
  2015: {
    zh: 'Node 名称不允许为空',
    en: 'Node name is empty',
    vi: 'Node name is empty',
  },
  2101: {
    zh: '组已经被订阅',
    en: 'Group already subscribed',
    vi: 'Group already subscribed',
  },
  2102: {
    zh: '组未被订阅',
    en: 'Group not subscribe',
    vi: 'Group not subscribe',
  },
  2103: {
    zh: '组不允许',
    en: 'Group not allow',
  ...
  2202: {
    ...
    vi: 'Tag name conflict',
  },
  2203: {
    zh: '点位属性不支持',
    en: 'Tag attribute not support',
    vi: 'Tag attribute not support',
  },
  2204: {
    zh: '点位类型不支持',
    en: 'Tag type not support',
    vi: 'Tag type not support',
  },
  2205: {
    zh: '点位地址格式无效',
    en: 'Tag address format invalid',
    vi: 'Tag address format invalid',
  },
  2206: {
    zh: '点位名称过长',
    en: 'Tag name too long',
    vi: 'Tag name too long',
  },
  2207: {
    zh: '点位地址过长',
    en: 'Tag address too long',
    vi: 'Tag address too long',
  },
  2208: {
    zh: '点位描述过长',
    en: 'Tag description too long',
    vi: 'Tag description too long',
  },
  2209: {
    zh: '点位精度无效',
    en: 'Tag precision invalid',
    vi: 'Tag precision invalid',
  },
  2210: {
    zh: '点位已存在',
    en: 'Tag exist',
  ...
  2301: {
    ...
    vi: 'Library not found',
  },
  2302: {
    zh: '库信息无效',
    en: 'Library info invalid',
    vi: 'Library info invalid',
  },
  2303: {
    zh: '库名称冲突',
    en: 'Library name conflict',
    vi: 'Library name conflict',
  },
  2304: {
    zh: '库打开失败',
    en: 'Library failed to open',
    vi: 'Library failed to open',
  },
  2305: {
    zh: '库模块无效',
    en: 'Libraray module invalid',
    vi: 'Libraray module invalid',
  },
  2306: {
    zh: '系统库不允许删除',
    en: 'Library system not allow del',
    vi: 'Library system not allow del',
  },
  2307: {
    zh: '插件不允许实例化',
    en: 'Library not allow create instance',
    vi: 'Library not allow create instance',
  },
  2308: {
    zh: '插件不支持此架构',
    en: 'Library arch not support',
    vi: 'Library arch not support',
  },
  2400: {
    zh: 'License 未找到',
    en: 'License not found',
    vi: 'License not found',
  },
  2401: {
    zh: 'License 无效',
    en: 'License invalid',
  ...
  addDriverByPlugin2404: {
    ...
    vi: 'The count of nodes exceeds the limit of the license, and the creation of the driver fails',
  },
  ...
  2405: {
    ...
    vi: 'Reach licensed max number of tags per node',
  },
  uploadLicense2405: {
  ...
  addDriverByTemplate2405: {
    ...
    vi: `The count of data points exceeds the limit of the license, and the creation of the driver fails`,
  },
  addTagByNode2405: {
    zh: `点位数超过 License 限制，添加失败`,
    en: `The count of data points exceeds the license limit, and the addition fails`,
    vi: `The count of data points exceeds the license limit, and the addition fails`,
  },
  importTag2405: {
    zh: `点位数超过 License 限制，导入失败`,
    en: `The count of data points exceeds the license limit, and the import fails`,
    vi: `The count of data points exceeds the license limit, and the import fails`,
  },
  2406: {
    zh: 'License 硬件不匹配',
    en: 'License hardware token not match',
    vi: 'License hardware token not match',
  },
  uploadLicense2406: {
  ...
  2407: {
    ...
    vi: 'License detect bad clock',
  },
  2408: {
    zh: 'License 模块无效',
    en: 'License module invalid',
    vi: 'License module invalid',
  },
  2500: {
    zh: '模板已存在',
    en: 'Template exist',
  ...
  2501: {
    ...
    vi: 'Template not found',
  },
  2502: {
    zh: '模板名称太长',
    en: 'Template name too long',
    vi: 'Template name too long',
  },
  3000: {
    zh: '插件读失败',
    en: 'Plugin read failure',
    vi: 'Plugin read failure',
  },
  3001: {
    zh: '插件写失败',
    en: 'Plugin write failure',
    vi: 'Plugin write failure',
  },
  3002: {
    zh: '插件未连接',
    en: 'Plugin disconnected',
    vi: 'Plugin disconnected',
  },
  3003: {
    zh: '插件 tag 不允许读',
    en: 'Plugin tag not allow read',
    vi: 'Plugin tag not allow read',
  },
  3004: {
    zh: '插件 tag 不允许写',
    en: 'Plugin tag not allow write',
    vi: 'Plugin tag not allow write',
  },
  3007: {
    zh: '插件 tag 类型不匹配',
    en: 'Plugin tag type mismatch',
    vi: 'Plugin tag type mismatch',
  },
  3008: {
    zh: '插件 tag 值失效',
    en: 'Plugin tag value expired',
    vi: 'Plugin tag value expired',
  },
  3009: {
    zh: '插件协议解析失败',
    en: 'Plugin protocol decode failure',
    vi: 'Plugin protocol decode failure',
  },
  3010: {
    zh: '插件未运行',
    en: 'Plugin not running',
    vi: 'Plugin not running',
  },
  3011: {
    zh: '插件 tag 未就绪',
    en: 'Plugin tag not ready',
    vi: 'Plugin tag not ready',
  },
  3012: {
    zh: '插件报文乱序',
    en: 'Plugin packet out of order',
    vi: 'Plugin packet out of order',
  },
  3013: {
    zh: '插件名称太长',
    en: 'Plugin name too long',
    vi: 'Plugin name too long',
  },
  3014: {
    zh: '插件未找到',
    en: 'Plugin not found',
  ...
  3015: {
    ...
    vi: 'Plugin device not response',
  },
  3016: {
    zh: '插件不支持模板',
    en: 'Plugin not support template',
    vi: 'Plugin not support template',
  },
  3017: {
    zh: '插件不支持写点位',
    en: 'Plugin not support write tags',
    vi: 'Plugin not support write tags',
  },
  4100: {
    zh: '字符串太长',
    en: 'String too long',
  ...
  4101: {
    ...
    vi: 'File open failure',
  },
  4102: {
    zh: '读文件失败',
    en: 'File read failure',
    vi: 'File read failure',
  },
  4103: {
    zh: '写文件失败',
    en: 'File write failure',
    vi: 'File write failure',
  },
  10001: {
    zh: 'Opcua 点位不存在',
    en: 'Opcua tag does not exist',
    vi: 'Opcua tag does not exist',
  },
  10002: {
    zh: 'Opcua 连接配置错误',
    en: 'Opcua connection configuration error',
    vi: 'Opcua connection configuration error',
  },
  10003: {
    zh: 'Opcua 访问超时',
    en: 'Opcua access timeout',
    vi: 'Opcua access timeout',
  },
  10004: {
    zh: 'Opcua 点位不可读',
    en: 'Opcua tag is not readable',
    vi: 'Opcua tag is not readable',
  },
  10005: {
    zh: 'Opcua 点位不可写',
    en: 'Opcua tag is not writable',
    vi: 'Opcua tag is not writable',
  },
  10006: {
    zh: 'Opcua 点位不支持',
    en: 'Opcua tag is not supported',
    vi: 'Opcua tag is not supported',
  },
  10101: {
    zh: '硬件错误',
    en: 'S7comm hardware error',
    vi: 'S7comm hardware error',
  },
  10103: {
    zh: '对象无访问权限',
    en: 'S7comm accessing the object not allowed',
    vi: 'S7comm accessing the object not allowed',
  },
  10105: {
    zh: '无效地址',
    en: 'S7comm invalid address',
    vi: 'S7comm invalid address',
  },
  10106: {
    zh: '数据类型不支持',
    en: 'S7comm data type not supported',
    vi: 'S7comm data type not supported',
  },
  10107: {
    zh: '数据类型不一致',
    en: 'S7comm data type inconsistent',
    vi: 'S7comm data type inconsistent',
  },
  10110: {
    zh: '对象不存在',
    en: 'S7comm object not exist',
    vi: 'S7comm object not exist',
  },
  10150: {
    zh: 'COTP 连接断开',
    en: 'S7comm cotp disconnected',
    vi: 'S7comm cotp disconnected',
  },
  10151: {
    zh: 'S7 连接断开',
    en: 'S7comm disconnected',
    vi: 'S7comm disconnected',
  },
  10152: {
    zh: '没有值',
    en: 'S7comm no value',
  ...
  10400: {
    ...
    vi: 'Nona11 invalid address',
  },
  10500: {
    zh: 'Fins 连接断开',
    en: 'Fins disconnected',
    vi: 'Fins disconnected',
  },
  10501: {
    zh: 'Fins 错误',
    en: 'Fins error',
  ...
  10502: {
    ...
    vi: 'Fins local node error',
  },
  10503: {
    zh: '目标节点错误',
    en: 'Fins dest node error',
    vi: 'Fins dest node error',
  },
  10504: {
    zh: '控制器错误',
    en: 'Fins communication controller error',
    vi: 'Fins communication controller error',
  },
  10505: {
    zh: '服务不受支持',
    en: 'Fins not executable',
    vi: 'Fins not executable',
  },
  10506: {
    zh: '路由表错误',
    en: 'Fins routing error',
    vi: 'Fins routing error',
  },
  10507: {
    zh: '命令格式错误',
    en: 'Fins command format error',
    vi: 'Fins command format error',
  },
  10508: {
    zh: '参数错误',
    en: 'Fins parameter error',
    vi: 'Fins parameter error',
  },
  10509: {
    zh: '无法读取',
    en: 'Fins read not possible',
    vi: 'Fins read not possible',
  },
  10510: {
    zh: '无法写入',
    en: 'Fins write not possible',
    vi: 'Fins write not possible',
  },
  10511: {
    zh: '当前模式不可执行',
    en: 'Fins not executable in current mode',
    vi: 'Fins not executable in current mode',
  },
  10512: {
    zh: '单元不存在',
    en: 'Fins no unit',
  ...
  10513: {
    ...
    vi: 'Fins start/stop not possible',
  },
  10514: {
    zh: '单元错误',
    en: 'Fins unit error',
  ...
  10515: {
    ...
    vi: 'Fins command error',
  },
  10516: {
    zh: '访问权限错误',
    en: 'Fins access error',
    vi: 'Fins access error',
  },
  10517: {
    zh: '中止',
    en: 'Fins abort',

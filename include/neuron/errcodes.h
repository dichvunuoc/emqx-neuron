...
typedef enum {
    ...
    NEU_ERR_PLUGIN_NOT_SUPPORT_EXE_ACTION    = 3023,
    NEU_ERR_PLUGIN_NOT_SUPPORT_DIRECTORY     = 3024,
    NEU_ERR_PLUGIN_NOT_SUPPORT_FUP_OPEN      = 3025,
    NEU_ERR_PLUGIN_NOT_SUPPORT_FDOWN_OPEN    = 3026,
    NEU_ERR_PLUGIN_NOT_SUPPORT_FUP_DATA      = 3027,
    NEU_ERR_PLUGIN_NOT_SUPPORT_FDOWN_DATA    = 3028,
    NEU_ERR_PLUGIN_NOT_SUPPORT_IMPORT_TAGS   = 3029,
    ...
    NEU_ERR_DATALAYERS_FAILURE         = 4200,
    NEU_ERR_DATALAYERS_INIT_FAILURE    = 4201,
    NEU_ERR_DATALAYERS_CONNECT_FAILURE = 4202,
    NEU_ERR_DATALAYERS_IS_NULL         = 4203,

    NEU_ERR_PLUGIN_ERROR_START = 10000,
    NEU_ERR_PLUGIN_ERROR_END   = 20000,

    NEU_ERR_S7COMM_HARDWARE_ERROR      = 10101,
    NEU_ERR_S7COMM_ACCESS_DENIED       = 10103,
    NEU_ERR_S7COMM_INVALID_ADDRESS     = 10105,
    NEU_ERR_S7COMM_TYPE_NOT_SUPPORTED  = 10106,
    NEU_ERR_S7COMM_TYPE_INCONSISTENT   = 10107,
    NEU_ERR_S7COMM_OBJECT_NOT_EXIST    = 10110,
    NEU_ERR_S7COMM_COTP_DISCONNECTED   = 10150,
    NEU_ERR_S7COMM_DISCONNECTED        = 10151,
    NEU_ERR_S7COMM_NO_VALUE            = 10152,
    NEU_ERR_S7COMM_VALUE_TOO_SHORT     = 10153,
} neu_err_code_e;
